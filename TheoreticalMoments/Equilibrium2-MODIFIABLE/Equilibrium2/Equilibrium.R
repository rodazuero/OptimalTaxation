...
rm(list=ls(all=TRUE))
Rcpp::sourceCpp('/Users/razuero/Dropbox/OptmalTaxationShared/Data/git/LastGitVersion/OptimalTaxation/TheoreticalMoments/Equilibrium2-MODIFIABLE/Equilibrium2/main.cpp')



GRAPHS="/Users/razuero/Dropbox/OptmalTaxationShared/Data/git/OptimalTaxation/TheoreticalMoments"
