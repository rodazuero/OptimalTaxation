...
arma::vec MinimizingDistance(arma::vec Parameters, arma::vec AdditionalVars){
    ...
    ubParameters[8]=5000;
    ubParameters[9]=5000;
    ubParameters[10]=5000;
    ubParameters[11]=5000;
    ubParameters[12]=5000;
    ubParameters[13]=5000;
    ubParameters[14]=2000;
    
    //Establishing the lower bounds
    double lbParameters[15];
    lbParameters[0]=0.000000005;
    lbParameters[1]=0.000000001;
    ...
    lbParameters[14]=0.000000001;

    
    //Putting the Other parameters in the double format
    double doubAdditionalPar[7];
