...
arma::vec MinimizingDistance(arma::vec Parameters, arma::vec AdditionalVars){
    ...
    for(int it=0; it<9; it++){
        cout <<"-----"<< endl;
        cout <<it<< " it "<< endl;
        cout <<lbParameters[it]<< " lbParameters[it] "<< endl;
        cout << ubParameters[it] << " ubParameters "<< endl;
    ...
    for(int it=0; it<15; it++){
        ...
        cout <<lbParameters[it]<< " lbParameters[it] "<< endl;
        cout << ubParameters[it] << " ubParameters "<< endl;
        cout <<ParamDoubles[it]<< " ParamDoubles[it]"<< endl;
    }
...
int main(int argc, const char * argv[]) {
    ...
    //This part is used to define the inputs of the minimizer.
    //ParamsInitial
    //aalpha ggamma ddelta  bbeta ssigma kkappa  psi  chi    rho mmu1 mmu2 ssigma1 ssigma2
    //  0.87   3.38 514.04 280.88   6.44    0.2 7.66 40.8 359.61 1.83 1.01    2.67    1.31
    //rho12     c NA. Indic
    //  0.98 19.81  NA     1
