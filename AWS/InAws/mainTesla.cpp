...
long double production(double ni, double nf, double aalpha, double tthetae,double c){
    double prod=tthetae*pow((c*0+ni+nf),aalpha);
    return(prod);
}

//2. Pre-tax profits.Checked. CX0 to exclude it
long double profm(double ni, double nf, double aalpha, double tthetae, double wi, double wf, double c){
    double pi1=tthetae*pow((c*0+ni+nf),aalpha)-wi*ni-wf*nf-TnActual(nf*wf);
    return(pi1);
    
}

//3. Corporate tax profits, marginalCX0 to exclude it
long double Tc(double z, double ni, double nf, double aalpha,double tthetae, double wi, double wf,double c){
    double profm=tthetae*pow((c*0+ni+nf),aalpha)-wi*ni-wf*nf-TnActual(nf*wf);
    double arg=profm-z;
...
//4. Tc Actual corporate taxesCX0 to exclude it
...
arma::vec EqWagesNumericVector(arma::vec Others, arma::vec WagesInit){
    ...
    EquilibriumValue.open("/home/ec2-user/InAws/EquilibriumValue.csv", ios::out | ios::app);
...
vector<vector<double> > TheoMoments(arma::vec Others, arma::vec WagesEquilibrium,
    ...
    for(int it=0; it<M; it++){
        ...
        if(DecVector[0][0]==1){
            ...
            TotalProduction+=production(DecVector[0][1],  DecVector[1][1],  aalpha,  Ttheta[1], 0);
        }
...
double DistanceEstimator(arma::vec Others, arma::vec WagesInit,
    ...
    ThMoments0CSV.open("/home/ec2-user/InAws/ThMoments0CSV.csv", ios::out | ios::app);
    ThMoments1CSV.open("/home/ec2-user/InAws/ThMoments1CSV.csv", ios::out | ios::app);
    ThMoments2CSV.open("/home/ec2-user/InAws/ThMoments2CSV.csv", ios::out | ios::app);
    ThMoments3CSV.open("/home/ec2-user/InAws/ThMoments3CSV.csv", ios::out | ios::app);
    ThMoments4CSV.open("/home/ec2-user/InAws/ThMoments4CSV.csv", ios::out | ios::app);
    ThMoments5CSV.open("/home/ec2-user/InAws/ThMoments5CSV.csv", ios::out | ios::app);
    ThMoments6CSV.open("/home/ec2-user/InAws/ThMoments6CSV.csv", ios::out | ios::app);
    ThMoments7CSV.open("/home/ec2-user/InAws/ThMoments7CSV.csv", ios::out | ios::app);
    ThMoments8CSV.open("/home/ec2-user/InAws/ThMoments8CSV.csv", ios::out | ios::app);
    ...
    ParametersCSV.open("/home/ec2-user/InAws/ParametersCSV.csv", ios::out | ios::app);
    ...
    DistanceMoments.open("/home/ec2-user/InAws/DistanceMoments.csv", ios::out | ios::app);
